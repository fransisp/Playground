...
import org.openapitools.server.model.getEmployeeBasedOnName

/**
 * Function to handle request send to getEmployeeInfo HTTP endpoint
 */
...
fun Route.employeeApi() {
    ...
    get<Paths.GetMemberInfo> {
        ...
        if (principal == null) {
            ...
            //check if the given id can be found
